...
class XLerobotConfig(RobotConfig):
    ...
    port1: str = None  # port to connect to left hand bus
    port2: str = None  # port to connect to right hand bus
    port3: str = None  # port to connect to neck/camera bus
    port4: str = None  # port to connect to wheels bus
